...
<!--        buttons -->
<!--      button LogIn -->
      <button class="log-in" name="submit"> Se connecter </button>
   </div>
  
<!--   other buttons -->
   <div class="other">
<!--      Forgot Password button-->
      <a><button class="btn" type="submit" href="forget.php" name="forget" value="Oublier mot de passe?"></button></a>
<!--     Sign Up button -->
