...
<form action="register.php" method="post">
   ...
   <div class="field-set">
	 ...
	 <span class="input-item">
        ...
        <!--   user name Input-->
         <input class="form-input" id="txt-input" name ="tel" type="text" placeholder="Telephone" required>
	  ...
	  <span class="input-item">
        ...
        <!--   user name Input-->
         <input class="form-input" id="txt-input" name ="email" type="text" placeholder="E-mail" required>
...
<!--        buttons -->
<!--      button LogIn -->
      <button class="log-in" name="submit"> S'inscrire </button>
